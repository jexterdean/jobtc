                    ...
                    <ul class="nav nav-tabs">
                        ...
                        <li class="dropdown pull-right">
                            ...
                            <ul class="dropdown-menu">
                                <li role="presentation"><a role="menuitem" tabindex="-1" href="{{ url('billing/'.$billing->billing_type)}}">Back</a></li>
                                <li role="presentation"><a role="menuitem" tabindex="-1" href="{{ url('billing/'.$data['billing_type'].'/'.$billing->billing_id.'/edit') }}" data-toggle='modal' data-target='#ajax'>Edit</a></li>
                                <li role="presentation"><a role="menuitem" tabindex="-1" href="{{ url('billing/'.$billing->billing_id.'/delete') }}">Delete</a></li>
                            </ul>
                        </li>
                    </ul>
						        ...
						        <div class="col-md-6">
						            <div class="box box-solid box-primary">
						                <div class="box-header">
						                    <h3 class="box-title">{{ studly_case($billing->billing_type) }} Ref # {{ $billing->ref_no }}</h3>
						                </div>
										<div class="box-body">
