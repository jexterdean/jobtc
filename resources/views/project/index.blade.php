@extends('layouts.default')
	@section('content')
		...
		<div class="col-md-12">
            <div class="box box-solid box-{{ Helper::getRandomColor() }}">
                <div class="box-header">
                    ...
                    <div class="box-tools pull-right">
                    	...
                    	<button class="btn btn-{{ Helper::getRandomColor() }} btn-sm" data-widget="collapse"><i class="fa fa-minus"></i></button>
                    </div>
                </div>
                <div class="box-body">
					...
					foreach ($projects as $project){
						...
						$linkStatus = Helper::getProgressStatus($project->project_progress);
