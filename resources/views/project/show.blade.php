            ...
            <div class="box-tools pull-right">
                ...
                <ul class="dropdown-menu">
                    <li role="presentation">
                        <a role="menuitem" tabindex="-1" href="{{ url('project') }}">Back</a>
                    </li>
                    <li role="presentation">
                        <a role="menuitem" tabindex="-1" href="{{ url('project/'.$project->project_id.'/edit') }}" class="show_edit_form" data-toggle='modal' data-target='#ajax'>Edit</a>
                    </li>
                    <li role="presentation">
                        <a role="menuitem" tabindex="-1" href="{{ route('project.destroy',$project->project_id) }}" class="alert_delete">Delete</a>
                    </li>
                </ul>
                <button class="btn btn-{{ \App\Helpers\Helper::getRandomColor() }} btn-sm" data-widget="collapse"><i class="fa fa-minus"></i></button>
            </div>
        </div>
        <div class="box-body">
