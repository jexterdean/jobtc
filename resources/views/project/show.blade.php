	                    ...
	                    <ul class="nav nav-tabs">
	                        ...
	                        <li class="dropdown pull-right">
	                            ...
	                            <ul class="dropdown-menu">
	                                <li role="presentation"><a role="menuitem" tabindex="-1" href="{{ url('project') }}">Back</a></li>
	                                <li role="presentation"><a role="menuitem" tabindex="-1" href="{{ url('project/'.$project->project_id.'/edit') }}" data-toggle='modal' data-target='#ajax'>Edit</a></li>
	                                <li role="presentation"><a role="menuitem" tabindex="-1" href="{{ url('project/'.$project->project_id.'/delete') }}">Delete</a></li>
	                            </ul>
	                        </li>
	                    </ul>
							                ...
							                <div class="box-header">
							                    ...
							                    <div class="box-tools pull-right">
													...
													{{ Form::open(['method' => 'POST','url' => 'endTimer','class' => 'form-horizontal']) }}
														<button type="submit" class="btn btn-danger btn-sm">End Timer <i class="fa fa-font"></i></button>
														{{ Form::hidden('project_id',$project->project_id)}}
														{{ Form::hidden('timer_id',$timer_check->timer_id) }}
													{{ Form::close() }}
													@else
													{{ Form::open(['method' => 'POST','url' => 'startTimer','class' => 'form-horizontal']) }}
														<button type="submit" class="btn btn-success btn-sm">Start Timer <i class="fa fa-font"></i></button>
														{{ Form::hidden('project_id',$project->project_id)}}
													{{ Form::close() }}
													@endif
							                    </div>
														...
														<tr>
															...
															<td>
																{{ Form::open(['method' => 'POST','url' => 'deleteTimer','class' => 'form-horizontal']) }}
																        <button type="submit" class="btn btn-danger btn-xs"><i class="icon-trash"></i> Delete</button>
