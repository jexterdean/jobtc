<div class="form-body">
    ...
    <div class="form-group">
        ...
        <div class="col-md-9">
            ...
            'form-control', 'placeholder' => 'Reference No', 'tabindex' => '3'])!!}
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-md-3">
            ...
            ($project->start_date)) : '', ['class' => 'form-control form-control-inline input-medium date-picker', 'placeholder' => 'Start Date', 'tabindex' => '4', 'data-inputmask' => "'alias': 'dd-mm-yyyy'", 'data-mask' => 'true'])  !!}
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-md-3">
            ...
            : '', ['class' => 'form-control form-control-inline input-medium date-picker', 'placeholder' => 'Due Date', 'tabindex' => '5', 'data-inputmask' => "'alias': 'dd-mm-yyyy'", 'data-mask' => 'true'])  !!}
        </div>
    </div>
    <div class="form-group">
