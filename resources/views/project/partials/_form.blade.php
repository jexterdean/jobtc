<div class="form-body">
    <div class="form-group">
        ...
        <div class="col-md-9">
            ...
            ['class' => 'form-control', 'placeholder' => 'Enter Project Title', 'tabindex' => '1']) !!}
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-md-9">
            {!!   Form::input('text','ref_no',isset($project->ref_no) ? $project->ref_no : '',['class' =>
            'form-control', 'placeholder' => 'Enter Reference No', 'tabindex' => '3'])!!}
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-md-3">
            ...
            ($project->start_date)) : '', ['class' => 'form-control form-control-inline input-medium date-picker', 'placeholder' => 'Enter Start Date', 'tabindex' => '4', 'data-inputmask' => "'alias': 'dd-mm-yyyy'", 'data-mask' => 'true'])  !!}
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-md-3">
            ...
            : '', ['class' => 'form-control form-control-inline input-medium date-picker', 'placeholder' => 'Enter Due Date', 'tabindex' => '5', 'data-inputmask' => "'alias': 'dd-mm-yyyy'", 'data-mask' => 'true'])  !!}
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-md-9">
            ...
            $project->project_description : '',['size' => '30x3', 'class' => 'form-control', 'placeholder' => 'Enter Project Description', 'tabindex' => '6']) !!}
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-md-9">
            ...
            'form-control', 'placeholder' => 'Enter Rate', 'tabindex' => '8']) !!}
        </div>
    </div>
    <div class="row">
