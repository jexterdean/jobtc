			...
			<div class="col-md-6 col-sm-12">
				...
				<div class="row">
					<div class="col-xs-6 text-center" style="border-right: 1px solid #f4f4f4">
                        ...
                        <input type="text" class="knob" data-readonly="true" value="{{ round(100-(($paid->totalPaid/$payable->totalSales)*100),2) }}" data-width="120" data-height="120" data-fgColor="{{ Helper::getRandomHexColor() }}"/>
                        @else
                        <input type="text" class="knob" data-readonly="true" value="0" data-width="120" data-height="120" data-fgColor="{{ Helper::getRandomHexColor() }}"/>
                        @endif
                        <div class="knob-label">Percentage Amount Due</div>
                    </div>
					<div class="col-xs-6 text-center" style="border-right: 1px solid #f4f4f4">
                        <input type="text" class="knob" data-readonly="true" value="{{ $inCompletProjects }}" data-width="120" data-height="120" data-fgColor="{{ Helper::getRandomHexColor() }}"/>
								...
								<tr>
									...
									<td>
										<div class="progress xs progress-striped active">
                                            <div class="progress-bar progress-bar-primary" style="width: {{ $project->project_progress }}%"></div>
                                        </div>	
                                    </td>
									<td><span class="badge bg-light-blue">{{ $project->project_progress }} %</span></td>
									<td>
										<a href="{{ url('project/'.$project->project_id) }}"><i class="fa fa-external-link"></i></a>
									</td>
								</tr>
							@endforeach
							</tbody>
                    ...
                    <div class="box-body" id="task-list-box">
                        ...
                        <ul class="todo-list">
                            ...
                            <li>
                                ...
                                <span class="badge bg-light-blue"><i class="fa fa-clock-o"></i> Till {{ date("d M Y",strtotime($task->due_date)) }}</span>
						...
						<table class="table table-bordered">
							...
							@foreach($tickets as $ticket)
								<tr>
									...
									<td>
										<a href="{{ url('ticket/'.$ticket->ticket_id) }}"><i class="fa fa-external-link"></i></a>
									</td>
								</tr>
							@endforeach
							</tbody>
