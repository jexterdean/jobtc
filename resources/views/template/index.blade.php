                ...
                <div class="box-body">
					...
					<div class="form-body">
						<div class="form-group">
							...
							<div class="col-md-9">
								<select onchange="if (this.value) window.location.href=this.value" name="template_id" id="template_id" class="form-control input-xlarge select2me" placeholder="Select One" tabindex="1">
