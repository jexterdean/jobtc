                ...
                <div class="box-body">
					...
					<div class="form-body">
						<div class="form-group">
							...
							<div class="col-md-10">
								<select onchange="if (this.value) window.location.href=this.value" name="template_url" id="template_url" class="form-control input-xlarge select2me" placeholder="Select One" tabindex="1">
						...
						<div class="form-group">
							...
							<div class="col-md-10">
								<textarea name="template_content" class="textarea form-control" rows="6" tabindex="2">{{ $template->template_content }}</textarea>
							</div>
						</div>
						<div class="row">
