                ...
                <div class="media-body">
                    ...
                    if(count($test_tags) > 0){
                        foreach($test_tags as $ref=>$tags){
                            $points = array_key_exists($tags, $v->test) ? $v->test[$tags] : 0;
                            ...
                            $max_points = array_key_exists($tags, $max_points_per_test) ? $max_points_per_test[$tags] : 0;

                            $points_width = number_format(($displayed_points/$max_points * 100), 2);
