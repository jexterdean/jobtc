                ...
                <div class="col-md-6">
                    ...
                    <div class="job-logged-out">
                            ...
                            <div class="job-content">
                                <div class="job-info row">
                                    <div class="col-md-12">
                                        <div class="media">
                                            @if(!Auth::check())
                                            <input class="btn btn-assign btn-lg pull-right apply-to-job" type="button" value="Apply"/>
                                            @endif
                        ...
                        <div class="job-header pull-right">
                            <a class="btn btn-edit btn-lg edit-job" data-toggle="modal"><i class="fa fa-pencil"></i>&nbsp;Edit</a>
                            <a class="btn btn-delete btn-lg delete-job"><i class="fa fa-trash-o"></i>&nbsp;Delete</a>
                            <input name="job_id" class="job_id" type="hidden" value="{{$job->id}}"/>
                        </div>
                        @endif
                    </div>
