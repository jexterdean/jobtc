                    ...
                    <div class="tab-pane active" id="tab_1">
                    	<div class="box box-success">
	                    	<div class="box-body chat" id="chat-box">
		                        ...
		                        <div class="item">
		                            <img src="{{ Helper::getAvatar($inbox_message->from_username) }}" alt="user image" class="online"/>
		                            <p class="message">
		                                <a href="#" class="name">
		                                    <small class="text-muted pull-right"><i class="fa fa-clock-o"></i> {{ date("d M Y h:ia",strtotime($inbox_message->created_at)) }} </small>
		                            ...
		                            <div class="attachment">
		                                ...
		                                <div class="pull-right">
		                                    <a href="{{ url('assets/message_attachment/'.$inbox_message->file) }}"><button class="btn btn-primary btn-sm btn-flat">Open</button></a>
		                                </div>
		                            </div>
		                            @endif
                    ...
                    <div class="tab-pane" id="tab_2">
                    	<div class="box box-success">
	                    	<div class="box-body chat" id="chat-box">
		                        ...
		                        <div class="item">
		                            <img src="{{ Helper::getAvatar($sent_message->to_username) }}" alt="user image" class="online"/>
		                            <p class="message">
		                                <a href="#" class="name">
		                                    <small class="text-muted pull-right"><i class="fa fa-clock-o"></i> {{ date("d M Y h:ia",strtotime($sent_message->created_at)) }} </small>
		                            ...
		                            <div class="attachment">
		                                ...
		                                <div class="pull-right">
		                                    <a href="{{ url('assets/message_attachment/'.$sent_message->file) }}"><button class="btn btn-primary btn-sm btn-flat">Open</button></a>
		                                </div>
		                            </div>
		                            @endif
